...
export const groundingData = {
  imageQA: [
    { question: '지금 보이는, 이미지는 무엇인가요?', gif: GroundingCat.src },
    { question: '가장 먼저, 보인 색깔은 무엇인가요?', gif: GroundingColor.src },
    { question: '눈앞에 보이는 게, 가볍게 느껴지나요?, 무겁게 느껴지나요?', gif: GroundingLeaf.src },
    { question: '지금 보이는 이미지는, 차가운 느낌인가요?, 따뜻한 느낌인가요?', gif: GroundingSnow.src },
    { question: '이미지를 보고, 어떤 감정이 떠오르나요?', gif: GroundingFamily.src },
  ],
  soundQA: [
    { question: '지금 들리는, 소리는 무엇인가요?', gif: GroundingSound.src, sound: '/sounds/rainy.mp3' },
    { question: '지금 들리는, 소리의 높이는 어떠한가요?', gif: GroundingSound.src, sound: '/sounds/fire.mp3' },
    {
      question: '이 소리가, 차분하게 들리나요?, 활기차게 느껴지나요?',
      gif: GroundingSound.src,
      sound: '/sounds/bird_valley.mp3',
    },
    { question: '소리가 점점 커지나요?, 작아지고 있나요?', gif: GroundingSound.src, sound: '/sounds/grassBug.mp3' },
  ],
  nothingQA: [
    { question: '지금 밟고 있는 곳은, 폭신한가요? 단단한가요?', gif: GroundingFoot.src },
    { question: '지금 주변에서, 들리는 소리는 무엇인가요?', gif: GroundingEar.src },
    { question: '지금, 어떤 냄새가 나나요?', gif: GroundingNose.src },
    { question: '입안의 작은 맛을, 그대로 느껴보세요., 어떤 맛이 느껴지나요?', gif: GroundingMouse.src },
    { question: '지금 손끝에, 닿는 감촉은 어떤가요?, 그대로 느껴보세요.', gif: GroundingHand.src },
    { question: '입고 있는 옷의, 촉감에 집중해보세요, 어떤 느낌인가요?', gif: GroundingClothes.src },
  ],
};
