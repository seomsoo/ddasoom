...
export default function Training() {
  return (
    <div className="flex flex-col inset-0 items-center mt-16 relative">
      ...
      <div className="flex ml-8 mt-7 bg-main4 border border-r-0 border-main1 shadow-md rounded-l-2xl w-full max-w-md p-4 py-7 mb-4 z-10">
      ...
      <div className="flex mr-8 items-start mt-8 border-l-0 bg-main4 border border-main1 shadow-md rounded-r-2xl w-full max-w-md p-4 py-7 mb-4 z-10">
      ...
      <div className="flex ml-8 mt-8 bg-main4 border border-r-0 border-main1 shadow-md rounded-l-2xl w-full max-w-md p-4 py-7 mb-4 z-10">
