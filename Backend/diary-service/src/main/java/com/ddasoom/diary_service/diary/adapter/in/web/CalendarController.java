...
import com.ddasoom.diary_service.diary.adapter.in.web.request.GetCalendarRequest;
...
public class CalendarController {
    ...
    public ApiResult<CalendarResponse> getCalendar(@RequestHeader("X-Authenticated-User") Long userId,
            @ModelAttribute GetCalendarRequest request) {
        return success(calendarQuery.getCalendar(userId, request.toCommand()));
    }
}
